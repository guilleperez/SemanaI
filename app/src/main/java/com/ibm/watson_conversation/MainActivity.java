...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        conversationService.setUsernameAndPassword(getString(R.string.conversationUsername), 
                getString(R.string.conversationPassword));
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                MessageResponse messageResponse = conversationService.message(
                        "b139cd03-4d87-4cc9-880a-9272e5ede68a", messageRequest).execute();
